                ...
                <div className="card" key={item.id}>
                    ...
                    <div className="card-image">
                        <Popup modal trigger={<button>
                            ...
                            Mandee is undergoing revam will be back soon!!!!
                        </Popup>
                    </div>
        ...
        return (
            <div className="container-fluid">
                ...
                <div className="responsive container-fluid">
                    ...
                    <div className="Btn">
                        <Popup modal trigger={<button className="btn-1">Signup
                    </button>}>
                            Mandee is undergoing revam will be back soon!!!!
                </Popup>
                        <Popup modal trigger={<button className="btn-1"><a href="#">Download App</a>
                        </button>}>
                            Mandee is undergoing revam will be back soon!!!!
                        </Popup>
                    </div>
